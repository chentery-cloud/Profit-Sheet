<script>
  ...
  function renderKPI() {
    ...
    let kpiList = [
      { key: "매출액", name: "총 매출액", unit: "백만원", actual: tSales || 0, target: kpiTarget["매출액"] || 11180, auto: true },
